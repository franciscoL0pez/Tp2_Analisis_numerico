...
def main() -> None:
    ...
    lista_volumen = calcular_volumen_euler_explicito(Vi,7,47,lista_Qe,lista_Qs)

    #print(lista_volumen)
    lista_DBO_h,lista_OD_h = calcular_DBO_OD_euler_explicito(lista_volumen,7,lista_Qe,lista_Qs)

    lista_volumen_sol_exacta = calcular_volumen_euler_explicito(Vi,0.001,47,lista_Qe,lista_Qs)
